...
// Level 6: Cytokine Storm (90 cols, WBC)
const l6 = padMap([
'',
'                                            ?',
'',
...
// Level 7: Bone Marrow Caverns (100 cols, RBC)
const l7 = padMap([
'',
'                                 ?        ?         ?       ?        ?',
'',
...
// Level 8: Complement Cascade (85 cols, WBC)
const l8 = padMap([
'',
'                                   ?',
'',
...
// Level 9: Allergic Storm (95 cols, RBC)
const l9 = padMap([
'',
'                              ?                ?              ?',
'',
...
// Level 10: Sepsis Finale (100 cols, WBC)
const l10 = padMap([
'',
'                             ?              ?              ?',
'',
...
// Build the new levels source code
const newLevels = `
...
// Find and replace the insertion point
const oldEnd = '    miniSpawnArea: { colStart: 18, colEnd: 40 },\n  },\n];';
const newEnd = '    miniSpawnArea: { colStart: 18, colEnd: 40 },\n  },' + newLevels + '\n];';
...
if (content.includes(oldEnd)) {
  ...
  // Also update LEVEL_DEFS
  const oldDefsEnd = '  { id:5, name:\'Boss感染\',   bgMusic:\'boss\',   enemies:[\'boss\'], mechanics:[\'sword\',\'dash\',\'stomp\',\'qblock\'], checkpoint:true },\n];';
  const newDefsEnd = '  { id:5, name:\'Boss感染\',   bgMusic:\'boss\',   enemies:[\'boss\'], mechanics:[\'sword\',\'dash\',\'stomp\',\'qblock\'], checkpoint:true },\n' +
  ...
  if (content.includes(oldDefsEnd)) {
    content = content.replace(oldDefsEnd, newDefsEnd);
    fs.writeFileSync('js/levels.js', content);
    console.log('LEVEL_DEFS updated successfully!');
  } else {
    console.log('WARNING: Could not find LEVEL_DEFS insertion point');
  }
} else {
  console.log('ERROR: Could not find LEVEL_MAPS insertion point');
